...
{   
    ...
    if(empty($firstname) || empty($middlename) || empty($lastname) || empty($address) || empty($email) || empty($contact) || empty($username) || empty($password)) {    
        ...
        //updating the table
        $query = "INSERT INTO appointments (firstname, middlename, lastname, address, email, contact, username, password) 
                VALUES ('$firstname','$middlename','$lastname','$address','$email','$contact','$username','$password')";
                    ...
                    <form class="form" method="post" action="">
                        ...
                        <div class="content">
                            <div class="input-group form-group-no-border input-lg">
                                ...
                                <h5 class="text-center mt-5">Book Appointment</h3>
                            </div>
                            <div class="input-group form-group-no-border input-lg">
                            ...
                            <div class="input-group form-group-no-border input-lg">
                                ...
                                <input type="text" id="username" name="username" class="form-control" placeholder="Appoinment Date" required>
                            </div>
                            <div class="input-group form-group-no-border input-lg">
                                <span class="input-group-addon">
                                    <i class="now-ui-icons ui-1_lock-circle-open"></i>
                                </span>
                                <input type="message" id="password" name="password" placeholder="Your message" class="form-control"  required>
                            </div>
                        </div>

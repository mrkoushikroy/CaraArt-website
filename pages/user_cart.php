              ...
              <div class="modal-dialog">
                <div class="modal-content">
                  ...
                  <div class="modal-body">
                      ...
                      <input type="text" class="form-control" name="shipaddress" placeholder="Address Line 1" required/>
                      <input type="text" class="form-control"  name="city" placeholder="Address Line 2">
                      </div>

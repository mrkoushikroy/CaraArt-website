        ...
        <div class="container">
            ...
            <div class="collapse navbar-collapse justify-content-end" id="navigation" data-nav-image="./assets/img/blurred-image-1.jpg">
                <ul class="navbar-nav">
                    ...
                    <li class="nav-item">
                        <a href="user_login_page.php" class="nav-link" href="javascript:void(0)" onclick="scrollToDownload()">
                            <i class="now-ui-icons users_single-02"></i>
                            <p>Login</p>
                        </a>
                    </li>
                    <li class="nav-item">
                        <a href="user_signup.php" class="nav-link" onclick="scrollToDownload()">
            ...
            <div class="section section-basic">
                <div class="container">
                     <h2>All Product List</h2>
                      <a class="btn btn-primary btn-round" href="../index.php"><i class="now-ui-icons arrows-1_minimal-left"></i> &nbsp Back to Home</a>
                      <hr color="orange"> 
                <br>
                <div class="col-md-12">
                <br>

...
<body class="index-page sidebar-collapse">
                ...
                <ul class="navbar-nav">
                    ...
                    <li class="nav-item">
                        <form method="POST" action="index_search.php" class="nav-link">
                            ...
                            <input type="text" class="form-control mr-sm-2  is-valid" type="search" name="search"
                                class="search-query" placeholder="Search product">
                        </form>
                    </li>
                    <!-- <li class="nav-item">
    ...
    <center>
        <br><br><br><br> <label><b class="h4">Search Details below: &nbsp</b></label> <br><br><label><b>Search Product:
                &nbsp</b></label>
                ...
                <div class="col-lg-2">
                    <h6><a class="btn btn-success btn-round" title="Click for more details!"
                            href="pages/product_details.php?prod_id=<?php echo $res['prod_id'];?>"><i
                                class="now-ui-icons gestures_tap-01"></i>More</a></h6>
                    <h6><a class="btn btn-outline-danger btn-round" title="Price"
                            href="pages/product_details.php?prod_id=<?php echo $res['prod_id'];?>"><i class="fa fa-inr"
                                aria-hidden="true"></i>Price <?php echo $res['prod_price']; ?></a></h6>
